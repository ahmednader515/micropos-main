...
export async function GET(request: NextRequest) {
  try {
    ...
    doc.text('تقرير بسندات الصرف لمورد', pageWidth / 2, margin + 10, { align: 'center', isInputRtl: true })
    ...
    const filename = `supplier_payments_${sanitizedName}_${new Date().toISOString().split('T')[0]}.pdf`
    ...
    console.error('Error generating supplier payments report PDF:', error)
