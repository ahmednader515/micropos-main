...
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch sales for tax declaration
    ...
    doc.text('تقرير بالاقرار الضريبي', pageWidth / 2, margin + 10, { align: 'center', isInputRtl: true })
    ...
    const filename = `tax_declaration_${new Date().toISOString().split('T')[0]}.pdf`
    ...
    console.error('Error generating tax declaration PDF:', error)
