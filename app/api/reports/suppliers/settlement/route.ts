...
export async function GET(request: NextRequest) {
  try {
    ...
    doc.text('تقرير بحركة التسديد لمورد', pageWidth / 2, margin + 10, { align: 'center', isInputRtl: true })
    ...
    const filename = `supplier_settlement_${sanitizedName}_${new Date().toISOString().split('T')[0]}.pdf`
    ...
    console.error('Error generating supplier settlement report PDF:', error)
